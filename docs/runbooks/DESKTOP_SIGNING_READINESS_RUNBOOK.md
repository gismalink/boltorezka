...
5. Публикует build в edge static web-root: `/ingress/static/datowave/<channel>/desktop/<channel>/<sha>/...`.
6. Обновляет channel manifest: `/ingress/static/datowave/<channel>/desktop/<channel>/latest.json`.
7. Генерирует mac updater feed: `/ingress/static/datowave/<channel>/desktop/<channel>/mac/latest-mac.yml` (+ `*-mac.zip`, `*.blockmap`).
