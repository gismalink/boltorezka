...
- [x] После стабильных метрик сформировать decision package по SFU-migration в `docs/plans/SFU_MIGRATION_PLAN.md`.
...
- Сформирован и зафиксирован canonical decision package: `docs/plans/SFU_MIGRATION_PLAN.md`.
