...
- [x] После стабильных метрик сформировать decision package по SFU-migration в `docs/plans/2026-03-06_SFU_MIGRATION_PLAN.md`.
...
- Сформирован и зафиксирован canonical decision package: `docs/plans/2026-03-06_SFU_MIGRATION_PLAN.md`.
