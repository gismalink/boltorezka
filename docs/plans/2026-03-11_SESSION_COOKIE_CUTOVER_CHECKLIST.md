...
- [ ] Для desktop prod readiness остаются зависимые пункты класса hardening/operations: auth/session rate limits, structured logs + audit trail, baseline/SLO доказательство.
