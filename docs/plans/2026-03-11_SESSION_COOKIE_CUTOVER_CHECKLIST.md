...
- [ ] UI/UX сценарии login/logout/session-expired не деградировали (ручной прогон не выполнен).
...
- [ ] Пройти ручной сценарий SSO callback + realtime join/reconnect (не выполнен).
