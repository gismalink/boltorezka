...
LIVEKIT_CMD="TEST_REF=${TEST_REF} TEST_RTC_MEDIA_TOPOLOGY_DEFAULT=p2p TEST_RTC_MEDIA_TOPOLOGY_SFU_ROOMS= TEST_RTC_MEDIA_TOPOLOGY_SFU_USERS= TEST_RTC_MEDIA_TOPOLOGY_LIVEKIT_ROOMS=${LIVEKIT_ROOM_SLUG} TEST_RTC_MEDIA_TOPOLOGY_LIVEKIT_USERS= SMOKE_ROOM_SLUG=general SMOKE_SFU_ROOM_SLUG=${LIVEKIT_ROOM_SLUG} SMOKE_SFU_EXPECT_MEDIA_TOPOLOGY=livekit SMOKE_REALTIME_MEDIA=0 npm run deploy:test:smoke"
...
| Profile | Smoke | Topology Gate | LiveKit Guard | Guard Nack Code | Realtime Media | TURN TLS | One-way Audio | One-way Video | NACK delta | ACK delta | Transport summary |
|---|---|---|---|---|---|---|---:|---:|---:|---:|---|
| sfu-current | ${SFU_STATUS} | ${SFU_TOPOLOGY_STATUS} | n/a | n/a | ${SFU_REALTIME_MEDIA} | ${SFU_TURN_TLS} | ${SFU_AUDIO_INCIDENTS} | ${SFU_VIDEO_INCIDENTS} | ${SFU_NACK_DELTA} | ${SFU_ACK_DELTA} | ${SFU_TRANSPORT} |
| livekit-topology | ${LIVEKIT_STATUS} | ${LIVEKIT_TOPOLOGY_STATUS} | ${LIVEKIT_GUARD_STATUS} | ${LIVEKIT_GUARD_CODE} | ${LIVEKIT_REALTIME_MEDIA} | ${LIVEKIT_TURN_TLS} | ${LIVEKIT_AUDIO_INCIDENTS} | ${LIVEKIT_VIDEO_INCIDENTS} | ${LIVEKIT_NACK_DELTA} | ${LIVEKIT_ACK_DELTA} | ${LIVEKIT_TRANSPORT} |
