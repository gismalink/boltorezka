...
const TEXT_BASE: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    "server.soundLow": "Низкое (экономия трафика)",
    "server.soundStandard": "Стандартное",
    "server.soundHigh": "Высокое (лучше качество)",
  ...
  en: {
    ...
    "server.soundLow": "Low (bandwidth saver)",
    "server.soundStandard": "Standard",
    "server.soundHigh": "High (better quality)",
