...
export function App() {
  ...
  const {
    ...
    pendingChatAttachmentFiles, selectAttachmentFiles, removePendingAttachmentAt, clearPendingAttachment,
  ...
  const chatVideoRuntimeInput = {
    ...
    chatText, pendingChatImageDataUrl, pendingChatAttachmentFiles,
    ...
    sendMessage, selectAttachmentFiles, removePendingAttachmentAt, clearPendingAttachment,
