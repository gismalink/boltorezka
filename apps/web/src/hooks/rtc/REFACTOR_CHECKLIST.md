...
- [ ] Улучшить ожидание событий в `scripts/smoke/smoke-realtime.mjs` (adaptive polling/backoff).
- [ ] Добавить опциональный строгий режим порога `OfferRateLimited` для race-сценариев.
